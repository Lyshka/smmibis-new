    ...
    cards: [
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Размещение рекламы на автобусе (полное брендированные) по Беларуси/Могилеву",
          },
          {
            id: 2,
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Размещение рекламы на заднем борту автобусов по Беларуси/Могилеву",
          },
          {
            id: 2,
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Размещение рекламы на баннерах в автобусе по Беларуси/Могилеву.",
          },
          {
            id: 2,
    ...
    cards: [
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Внедрение и настройка модуля онлайн бронирования для отеля/базы отдыха/ апартаментов – до 10 номеров",
          },
          {
            id: 2,
          ...
          {
            id: 6,
            title: "Настраиваем и тестируем каналы приема сообщений о бронировании",
          },
          {
            id: 7,
            title: "Дополнительный бонус регистрации Вашего объекта и номеров на сервисе OSTROVOK.RU",
          },
        ],
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Внедрение и настройка модуля онлайн бронирования для отеля/базы отдыха/ апартаментов – до 30 номеров",
          },
          {
            id: 2,
            title: "Вносим с описанием все гостиничные номера в модуль",
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Внедрение и настройка модуля онлайн бронирования для отеля/базы отдыха/ апартаментов – больше 30 номеров",
          },
          {
            id: 2,
            title: "Вносим с описанием все гостиничные номера в модуль",
    ...
    cards: [
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Разработка сценария, съемка и монтаж презентационных роликов о предприятии, товарах, услугах, коллективе",
          },
        ],
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Фото/видео съемка товаров/ блюд/ гостиничных номеров/ ресторанов/ бизнес ивентов и т.п.",
          },
        ],
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Изготовление продающих анимационных 3D промороликов (видео до 2 мин) с использованием реального изображения товаров",
          },
        ],
      },
      {
    ...
    cards: [
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Написание уникальных текстов под релевантные запросы пользователей",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        includeServices: [
          {
            id: 1,
            title: "Разработка презентаций о предприятии, товаре, услуге в Power point, Google presentation",
          },
        ],
      },
    ],
