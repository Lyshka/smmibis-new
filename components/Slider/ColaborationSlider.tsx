    ...
    <div className="WrapperSliderColoboration relative">
      <div className="flex gap-6 sliderColoboration">
        {[...colobaration, ...colobaration].map(({ id, img }, idx) => (
          ...
          >
            <Image className="2xl:block hidden" width={192} height={134} src={img} alt="colobaration" />
            <Image className="2xl:hidden block" width={94} height={94} src={img} alt="colobaration" />
          </div>
        ))}
      </div>
    </div>
